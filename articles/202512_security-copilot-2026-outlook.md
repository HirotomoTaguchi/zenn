...
*上記は、MDEでメモリダンプや不振なPowerShell実行などの挙動を検知し、その後RDPで横展開しようとしたところをMDIでユーザー無効化することで封じ込めしたケースの解説をしてもらっています。初見だと、なかなか何が起こったのかわかりにくいはず*

もちろん、「AIがこう言っています」は「Defenderが勝手に対応してくれました」と同じぐらい無責任なことですが、ゼロから読み解くよりはだいぶマシです。時給換算で約600円という価格設定は、他のユースケースも含めて薄くフル活用できる環境であれば十分に投資対効果が見込める水準だと感じています。
