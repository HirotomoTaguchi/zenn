...
**記載すること**
- Microsoft Defender for Endpoint (MDE) P2ライセンスの範囲でできる「ファイル調査」の方法
- 各調査段階で確認すべき具体的なポイント
...
前置きが本当に長くなってしまいましたが、ここからが本題です。ファイルプロファイルページへのアクセスし、踏査していきます。アラート詳細画面からファイル名またはハッシュ値をクリックして「ファイルプロファイル」ページに移動します。
